...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $existSql = "SELECT * FROM `user` WHERE `name` = '$username' OR `email` = '$email'";
    ...
    if($numExistRows > 0){
        ...
        if(($password == $cpassword)){
            ...
            $sql = "INSERT INTO `blog_db`.`user` (`name`, `email`, `password`, `cpassword`,`dt`) VALUES ('$username', '$email', '$password', '$cpassword', current_timestamp())";
...
<body>
    ...
    <header>
        <div class="nav-bar">
            ...
            <div id="mid-nav">
                <ul id="central-side">
                    <li><a href="./index.html#features-div">Features</a></li>
                    <li><a href="./index.html#pricing-div">Pricing</a></li>
                </ul>
            </div>
            <div id="mid-nav">
                <ul id="left-side">
