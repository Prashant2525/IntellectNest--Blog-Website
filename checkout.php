...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $existSql = "SELECT * FROM `cards` WHERE `c_name` = '$name'";
    $res = mysqli_query($conn, $existSql);
    $numExistRows = mysqli_num_rows($res);
    if ($numExistRows > 0) {
        $showError = "Already a Member of Premium";
    } else {
        $sql = "INSERT INTO `blog_db`.`cards` (`c_name`, `c_email`,`c_num`, `c_expire`, `c_cvv`, `dt`) VALUES ('$name', '$email', '$card_num', '$expire', '$cvv', current_timestamp())";
                                            ...
                                            <form class="mt-4" method="post">
                                                <div data-mdb-input-init class="form-outline form-white mb-4">
                                                    <input type="text" id="typeName"
                                                        ...
                                                        placeholder="Cardholder's Name" name="name" required />
                                                    ...
                                                    <div class="col-md-6">
                                                        <div data-mdb-input-init class="form-outline form-white">
                                                            <input type="text" id="typeExp"
                                                                ...
                                                                maxlength="7" name="expire" required />
                                                    ...
                                                    <div class="col-md-6">
                                                        <div data-mdb-input-init class="form-outline form-white">
                                                            <input type="password" id="typeText"
                                                                class="form-control form-control-lg"
                                                                placeholder="&#9679;&#9679;&#9679;" size="1"
                                                                minlength="3" maxlength="3" name="cvv" required />
