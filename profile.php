...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (!empty($_FILES["file_upload"]["name"])) {
    ...
    $updateSql = "UPDATE `user` SET `file` = '$folder', `name` = '$newUsername', `email` = '$newEmail', `phone` = '$newPhone' WHERE `email` = '$email'";
  } else {
    $updateSql = "UPDATE `user` SET `name` = '$newUsername', `email` = '$newEmail', `phone` = '$newPhone' WHERE `email` = '$email'";
  }
